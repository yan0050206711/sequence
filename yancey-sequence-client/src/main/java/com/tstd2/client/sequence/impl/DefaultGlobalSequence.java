...
import com.tstd2.client.sequence.dao.GlobalSequenceDao;
...
import com.tstd2.client.sequence.task.GlobalSequenceBufferPoolCheckTask;
...
public class DefaultGlobalSequence implements GlobalSequence {
     ...
     * 号池
     */
    protected static SequenceBufferPool<String, Long> BUFFER_POOL = new SequenceBufferPool<String, Long>();
    ...
    public long nextValue(String appName) {
        ...
        while (incrementId == null) {
            ...
            try {
                ...
                LOGGER.warn("出现异常，appName={}, error={}", appName, e);
                continue;
            } finally {
                lock.unlock();
            }
